...
Starting with version `0.2.0`, the library targets **.NET 8 (`net8.0`)**.
The sample applications target **.NET 8 for Windows (`net8.0-windows`)**.

If you need .NET Standard 1.1 or .NET Framework support, use the `0.1.3`
